...
document.write('<link href="' + bootPATH + 'layui/css/xadmin.css" rel="stylesheet" type="text/css" />');

//layUI
document.write('<script src="' + bootPATH + 'layui/jquery.min.js" type="text/javascript"></script>');
