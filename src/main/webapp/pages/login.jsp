...
<script
	src="${pageContext.request.contextPath}/resource/js/layui/jquery.min.js"
	type="text/javascript"></script>
	
<script
	src="${pageContext.request.contextPath}/resource/js/jquery-jrumble.js"
	type="text/javascript"></script>
...
<body>
	...
	top.location.href=self.location.href; 
		...
		function doLogin(){
			...
			//loginForm.submit();
			location.href="${pageContext.request.contextPath}/pages/workspace/main.jsp";
		}
